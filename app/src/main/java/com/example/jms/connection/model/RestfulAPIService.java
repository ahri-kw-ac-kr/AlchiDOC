...
public interface RestfulAPIService {
    ...
    /**
     * GET
     * BaseURL/user/1/sleep
     * 1번 유저의 sleep data 조회
     **/
    @GET("user/{id}/sleep")
...
/******************************  Sleep  ************************************/
     ...
     **/
    @GET("sleep")
    Single<PageDTO<SleepDTO>> getAllSleep();
     ...
     **/
    @GET("sleep/{id}")
    Single<SleepDTO> getSleep(@Path("id") Long id);
    ...
    //@FormUrlEncoded
    @POST("sleep")
    Single<SleepDTO> postSleep(@Body SleepDTO sleep);
    ...
    //@FormUrlEncoded
    @PATCH("sleep/{id}")
    Single<SleepDTO> patchSleep(@Path("id") Long id, @Body SleepDTO sleep);
    ...
    //@FormUrlEncoded
    @PATCH("sleep")
    Single<List<SleepDTO>> patchAllSleep(@Body List<SleepDTO> sleep);
     ...
     **/
    @DELETE("sleep/{id}")
    Single<SleepDTO> deleteSleep(@Path("id") Long id);
}